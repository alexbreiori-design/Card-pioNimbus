  ...
  return (
    <LandingScene id="recursos" className="landing-section-scene landing-features-scene">
      <div className="landing-container landing-features">
        <LandingReveal delay={0} className="landing-features__head">
          ...
          <p className="landing-features__lead">{landingFeaturesShowcase.lead}</p>
        </LandingReveal>

        <LandingReveal delay={100} className="landing-features-showcase">
