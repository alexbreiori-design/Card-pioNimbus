import { NIMBUS_PRICE, NIMBUS_PRICE_ANNUAL, NIMBUS_WHATSAPP, whatsappUrl } from '@/lib/landing/constants';
...
export const LANDING_META = {
  ...
  description:
    'Cardápio digital com pedidos, entregas, gestão e personalização. Tudo incluso a partir de R$ 199,90/mês, suporte humano e ativação em até 48h.',
  ogImagePath: '/images/landing/hero/devices-idle.webp',
};
    ...
    '@graph': [
      ...
      },
      {
        ...
        offers: {
          ...
          url: origin,
          description: `Plano mensal ${NIMBUS_PRICE}/mês · anual equivalente a ${NIMBUS_PRICE_ANNUAL}/mês`,
        },
