...
export const NIMBUS_STRIPE_PLANS = [
  {
    codigo: 'loja_nova',
    label: 'Loja Nova',
    descricao: 'Primeira loja / assinatura principal (mensal)',
    valorCentavos: 19990,
    intervalo: 'month',
  ...
  },
  {
    ...
    descricao: 'Oferta já passada a clientes / Price legado mensal',
    valorCentavos: 14990,
    intervalo: 'month',
    envKey: 'STRIPE_PRICE_LOJA_NOVA_149',
  },
  {
    codigo: 'loja_nova_anual',
    label: 'Loja Nova (Anual)',
    descricao: 'Primeira loja com cobrança anual (equiv. R$ 149,90/mês)',
    valorCentavos: 179880,
    valorMensalEquivCentavos: 14990,
    intervalo: 'year',
    envKey: 'STRIPE_PRICE_LOJA_NOVA_ANUAL',
  },
  {
    codigo: 'segunda_loja',
    label: 'Segunda Loja',
...
export function listConfiguredPlans() {
  return NIMBUS_STRIPE_PLANS.map((plan) => {
    ...
    return {
      ...
      valorMensalEquivCentavos: plan.valorMensalEquivCentavos || null,
      intervalo: plan.intervalo || 'month',
      priceId,
