...
export function buildFooterPaymentLabels(_exibirPixCardapio = true) {
  // Pix manual (comprovante) oculto no cardápio; Pix online continua nas opções de pagamento quando houver integração.
