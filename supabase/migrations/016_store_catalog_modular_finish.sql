-- Migration 016 COMPLETA (idempotente)
-- Use este arquivo se a 016 falhou no meio (transação reverteu tudo).
-- Não recria usuario_pertence_empresa — reutiliza a função existente (parâmetro eid).
...
-- -----------------------------------------------------------------------------
-- RLS — reutiliza usuario_pertence_empresa(eid) já existente
-- -----------------------------------------------------------------------------
